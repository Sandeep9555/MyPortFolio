...
const Hero = () => {
  const onButtonClick = () => {
    const pdfUrl =
      "https://drive.google.com/file/d/1gNftNengfDxGNY01ZnebZ0SwR4hT5eV8/view?usp=drivesdk";
      ...
      <div className="container pt-14">
        ...
        <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
          <div className="w-2/4 md:basics-1/2">
            ...
            >
              I'm Sandeep Singh <br /> Software Developer
            </h1>
            ...
            >
              <a href="mailto:sandeepsingg6392@gmail.com">
