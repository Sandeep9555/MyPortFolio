      ...
      <div className="container">
        <div className="sm:flex items-center justify-between md:gap-8">
          <div className="w-full sm:w-1/2">
            ...
            <a href="mailto:sandeepsingg7392@gmail.com">
          ...
          <div className="w-full sm:w-1/2">
            ...
            <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10">
              ...
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://www.linkedin.com/in/sandeep-singh-268808227"
              ...
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://github.com/Sandeep9555"
                  className="text-gray-300 text-[18px] font-[500]"
                >
              ...
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://leetcode.com/sandeep234/"
                  className="text-gray-300 text-[18px] font-[500]"
                >
              ...
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://www.geeksforgeeks.org/user/sandeepsingg113/"
                  className="text-gray-300 text-[18px] font-[500]"
                >
                  <Icon icon="simple-icons:GeekforGeeks" />
                </a>
              </span>
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
          ...
          <div className="flex items-center justify-center sm:justify-between">
            ...
            <div>
              <p className="text-gray-400 text-[14px] ">
                Copyright {year} developed by Sandeep Singh - All rights
                reserved.
              </p>
            </div>
          </div>
